...
def build_data_context(intent: str, query: str, computed_results: str | None = None, signals: dict | None = None) -> str:
    ...
    try:
        ...
        # Time Context (Simulated for Demo)
        ...
        context_parts.append("- production_data: physical units and revenue.")
        ...
        if signals:
            ...
            context_parts.append(f"- alerts_spike: {signals.get('alerts_spike', False)}")
            context_parts.append(f"- production_drop: {signals.get('production_drop', False)}")
            context_parts.append(f"- affected_departments: {signals.get('affected_departments', [])}")
